...
def predict_images_in_folder(folder_path, predictor, output_excel_path):
    """
    ...
    for i, image_path in enumerate(image_paths):
        ...
        # 使用預測器對圖片進行預測並保存結果
        classify_and_save(image, predictor, output_image_path, output_json_path, i, excel_data)
...
if __name__ == "__main__":
    ...
    output_excel_path = "reslut.xlsx"  # 設置 Excel 文件的保存路徑
    ...
    # 對每張圖片進行預測
    predict_images_in_folder(folder_path, predictor, output_excel_path)
