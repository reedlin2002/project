...
def gui():
    ...
    def start_video_processing():
        ...
        cut_frames = (total_frame - start_point) / frame_cut
        cut_frames = int(cut_frames) + 1
        
        completion_label.config(text=f"切出的圖片數量: {cut_frames}")
    ...
    #要用幾幀切
    label = tk.Label(root, text="請輸入要切割的幀數：")
